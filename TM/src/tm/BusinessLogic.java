...
public class BusinessLogic 
{
    ...
    public static Connection buildConnectionDB(){
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:sqlserver://ec2-13-58-47-139.us-east-2.compute.amazonaws.com:1433;databaseName=dbMaster;user=ehaddy;password=SacState$01;");
            return con;
        }catch(Exception e){
